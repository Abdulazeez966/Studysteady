...
const features = [
  { title: "One clear next step", text: "No decision fatigue. Just today's task, waiting for you." },
  { title: "Manageable tasks", text: "Big goals broken into steps small enough to actually finish." },
  { title: "A way back, not a guilt trip", text: "Miss a week? Pick up exactly where you stopped — no backlog dumped on you." },
  { title: "Reminders you control", text: "You decide when we reach out, and how often. Never more." },
];
    ...
    <div className="ss-landing">
      <header className="ss-landing__nav">
        <div className="ss-landing__nav-inner">
          ...
          <div className="ss-landing__nav-actions">
            <Link to="/login" className="ss-auth-link">Log in</Link>
            <Link to="/signup" className="ss-btn-primary ss-btn-primary--compact">Sign up</Link>
          </div>
        </div>
      </header>
      ...
      <section className="ss-landing__hero">
        <div className="ss-landing__hero-inner">
          ...
          <p className="ss-landing__subtitle">
            Stay on track with your learning, even when life gets busy — plan realistically,
            know exactly what to do next, and get back on track no matter how many times you fall behind.
          </p>
          <div className="ss-landing__cta-row">
            <Link to="/signup" className="ss-btn-primary">Get started</Link>
            <Link to="/login" className="ss-btn-secondary">Log in</Link>
          </div>
        </div>
      </section>
      ...
      <section className="ss-landing__cta-banner">
        <div className="ss-landing__cta-banner-inner">
          ...
          <Link to="/signup" className="ss-btn-secondary">Create your account</Link>
        </div>
      </section>
